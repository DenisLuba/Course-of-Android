...
import com.example.p007_fragmentnavigation.databinding.FragmentBoxSelectionBinding
import com.example.p007_fragmentnavigation.databinding.ItemBoxBinding
...
class BoxSelectionFragment : Fragment(), HasCustomTitle {
    ...
    private fun createBoxes() {
        val boxBindings = (0 until options.boxCount).map { index ->
            ...
            boxBinding.root.setOnClickListener(::onBoxSelected)

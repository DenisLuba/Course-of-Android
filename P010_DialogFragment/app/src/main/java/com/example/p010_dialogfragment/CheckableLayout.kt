...
//    ***************************************************************************
    ...
    override fun toggle() = checkableChild.toggle()

    override fun setChecked(checked: Boolean) { checkableChild.isChecked = checked }

//    ***************************************************************************

    override fun onFinishInflate() {
        super.onFinishInflate()
        val checkableView: View = checkableChild as View
